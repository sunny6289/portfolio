        ...
        <section className='page flex flex-col items-center justify-evenly p-5'>
            <div className="img-identity flex md:gap-5 items-start  md:px-10 md:justify-normal flex-wrap">
                ...
                <div className="name-work flex flex-col max-w-fit mx-auto justify-center gap-3">
                    ...
                    <a className='flex gap-2 items-center bg-black rounded-md max-w-fit px-3 py-2 cursor-pointer mx-auto active:scale-95' href="/Sunny_Mishra_Resume.pdf" download="Sunny_Mishra_Resume.pdf" title='Download Resume'><FaDownload /><span>Download Resume</span></a>
